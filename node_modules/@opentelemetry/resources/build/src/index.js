...
// Polyfill for resourceFromAttributes (added in OTel 1.31)
if (typeof exports.resourceFromAttributes === 'undefined') {
  exports.resourceFromAttributes = function resourceFromAttributes(attributes) {
    return new exports.Resource(attributes);
  }
}
